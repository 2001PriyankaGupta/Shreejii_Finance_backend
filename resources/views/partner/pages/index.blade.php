        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-[#0346cbff] to-indigo-800 rounded-[2.5rem] p-10 mb-10 shadow-[0_20px_50px_-15px_rgba(3,70,203,0.3)] text-white relative overflow-hidden group">
                <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('admin.partners.download-pdf') }}" class="px-6 py-3 bg-white text-[#0346cbff] text-xs font-black rounded-2xl transition-all shadow-lg hover:scale-105 active:scale-95 flex items-center">
            ...
            <div class="bg-white rounded-[2.5rem] shadow-xl border border-white p-8 overflow-hidden group hover:border-[#0346cbff]/30 transition-all duration-500">
                ...
                <div class="overflow-x-auto">
                    <table id="partnersTable" class="w-full text-[13px] text-left border-separate border-spacing-y-2">
                        <thead>
                            <tr class="text-[11px] font-black text-slate-400 uppercase tracking-[0.2em]">
                                <th class="px-5 py-3 whitespace-nowrap">Partner Identity</th>
                                <th class="px-5 py-3 whitespace-nowrap">Business Name</th>
                                ...
                                <tr class="bg-slate-50/50 hover:bg-white hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-300 rounded-[2rem] group/row scale-100 hover:scale-[1.01]">
                                    <td class="px-5 py-3">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="font-black text-slate-900 text-sm leading-tight">{{ $partner->name }}</div>
                                                <div class="text-[9px] font-black text-[#0346cbff] bg-[#0346cbff]/5 px-2 py-0.5 rounded-md mt-0.5 inline-block uppercase tracking-widest">ID: PARTNER-{{ $partner->id ?? 'N/A' }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-5 py-3">
                                    ...
                                    <td class="px-5 py-3">
                                        ...
                                        @elseif($partner->status === 'REJECTED')
                                            <span class="px-3 py-1 bg-rose-500/10 text-rose-600 rounded-lg text-[9px] font-black uppercase tracking-widest border border-rose-500/10 inline-block">
                                                Rejected
                                            </span>
                                        @else
                                            <span class="px-3 py-1 bg-amber-500/10 text-amber-600 rounded-lg text-[9px] font-black uppercase tracking-widest border border-amber-500/10 inline-block animate-pulse">
                                                Pending
                                            </span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="px-5 py-3 text-right">
                                        <div class="flex justify-end space-x-1.5">
                                            <a href="{{ route('admin.partners.show', $partner->id) }}" class="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center hover:bg-[#0346cbff] hover:text-white transition-all shadow-sm">
